using temp_clean_arch.Application.TodoLists.Queries.GetTodos;
using temp_clean_arch.Domain.Entities;
using temp_clean_arch.Domain.ValueObjects;

namespace temp_clean_arch.Application.FunctionalTests.TodoLists.Queries;
